...
export default class Diario extends Component{
  ...
  handleAddItem = addItem => {
    fetch("https://cors-anywhere-redsocial.herokuapp.com/https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/diario/tareas/",{
      method: "POST",
      headers: {
...
handleRemoveItem= id =>{
  ...
  fetch('https://cors-anywhere-redsocial.herokuapp.com/https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/diario/tareas/'+userId+'/'+id,{method:'DELETE'})
  .then(res=>res.json()).then(data=>this.setState({
    task: data.task
  }))
}
...
handleUpdateItem=id=>{
  ...
  const sessionJson = JSON.parse(sessionStr)
  const userId = sessionJson.user._id
  fetch('https://cors-anywhere-redsocial.herokuapp.com/https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/diario/tareas/'+userId+'/'+id,{method:'PUT'})
  .then(res=>res.json()).then(data=>this.setState({
    task: data.task
  }))
}
