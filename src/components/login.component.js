...
export default class Login extends Component {
  ...
  handleSubmit = async event => {
    ...
    await fetch("https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/",{
        method: "POST",
        headers: {
  ...
  signup(res) {
        ...
        fetch("https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/sign-up",{
          method: "POST",
          headers: {
              "Content-Type": "application/json"
          },
