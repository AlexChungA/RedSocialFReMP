...
const Chat = () => {
    ...
    const getMessages = async() => {
      fetch(`https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/messages/${roomId}/`,{method:'GET'}).then(res=>res.json())
      .then((data) => {
    ...
    const getFriends = async() => {
      console.log(userId);
      fetch(`https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/users/${userId}/friends/`,{method:'GET'}).then(res=>res.json())
      .then((data) => {
          //console.log(data);
