...
export default function TaskList(props) {
    ...
    useEffect(() => {
        ...
        fetch('https://cors-anywhere-redsocial.herokuapp.com/https://cors-anywhere-redsocial.herokuapp.com/https://red-social-fc.herokuapp.com/diario/tareas/'+userId+'/'+date)
